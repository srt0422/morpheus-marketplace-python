...
class TestSessions:
    ...
    def test_method_provider_claim(self, client: MorpheusMarketplace) -> None:
        ...
        assert_matches_type(SessionProviderClaimResponse, session, path=["response"])
    ...
    def test_method_provider_claimable_balance(self, client: MorpheusMarketplace) -> None:
        ...
        assert_matches_type(SessionProviderClaimableBalanceResponse, session, path=["response"])
