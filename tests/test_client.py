...
from morpheus_marketplace import MorpheusMarketplace, AsyncMorpheusMarketplace, APIResponseValidationError
...
def _get_open_connections(client: MorpheusMarketplace | AsyncMorpheusMarketplace) -> int:
...
class TestMorpheusMarketplace:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "morpheus_marketplace/_legacy_response.py",
                        "morpheus_marketplace/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "morpheus_marketplace/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: MorpheusMarketplace) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: MorpheusMarketplace) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MorpheusMarketplace) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MorpheusMarketplace) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_omit_retry_count_header(
        self, client: MorpheusMarketplace, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMorpheusMarketplace:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMorpheusMarketplace) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncMorpheusMarketplace) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMorpheusMarketplace) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMorpheusMarketplace) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncMorpheusMarketplace,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMorpheusMarketplace, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
